...
// AdminPortal has accumulated several build-time patches over time. Do not try
// to delete individual declarations with fragile regexes. Instead, replace the
// complete minister-state section between two stable state anchors. This makes
// the build deterministic even when an earlier script inserted a combined or
// duplicated mImage2/mImage3/ministerFit declaration.
