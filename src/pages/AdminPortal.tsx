...
export function AdminPortal({ onBack }: AdminPortalProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-neutral-200 font-sans flex relative overflow-x-hidden">
      ...
      {/* MAIN CONTENT AREA - FIXED WITH FLEX-1 AND MIN-W-0 TO EXPAND PROPERLY */}
      <main className="flex-1 flex flex-col min-h-screen min-w-0 overflow-y-auto bg-[#0a0a0a]">
        ...
        <div className="p-6 flex-1 w-full box-border">
          ...
          {/* TAB 4: LIVE STREAM */}
          {activeTab === 'live' && (
            <div className="max-w-xl mx-auto bg-[#121212] border border-[#262626] p-8 rounded-2xl shadow-xl w-full">
              <div className="pb-4 mb-6 border-b border-[#262626]">
                <h2 className="text-xs font-bold text-white tracking-wide uppercase flex items-center space-x-2">
                  <span className="w-1.5 h-4 bg-[#f59e0b] rounded-full"></span>
